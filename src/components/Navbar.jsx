  ...
  return (
    <nav className="navbar">
      ...
      <svg height="40px" width="40px" viewBox="0 0 512 512" xmlns="http://www.w3.org/2000/svg">
          <path style={{ fill: '#FFC61B' }} d="M196.594,512c-1.716,0-3.45-0.313-5.119-0.96c-5.85-2.273-9.504-8.13-8.971-14.384l14.522-170.571
          ...
          <polygon style={{ fill: '#FEE187' }} points="274.026,255.36 129.983,255.36 199.925,70.724 307.059,70.724 249.356,207.284 
            346.772,207.284 259.542,338.02 "/>
          <path style={{ fill: '#FFC61B' }} d="M259.538,352.166c-1.76,0-3.54-0.328-5.255-1.016c-6.21-2.487-9.828-8.983-8.674-15.572
